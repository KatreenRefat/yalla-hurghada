...
import { FaWifi, FaSnowflake, FaCrown, FaPlane, FaUser, FaHeadset, FaPeopleCarry, FaSuitcase, FaClock, FaTimesCircle } from "react-icons/fa";
...
const translations = {
  EN: { reviews: "reviews", perPerson: "/person", bookNow: "Book This Tour →" },
  AR: { reviews: "تقييم", perPerson: "/شخص", bookNow: "احجز الجولة →" },
  RU: { reviews: "отзывов", perPerson: "/чел.", bookNow: "Забронировать →" },
};

const FeaturedToursCarouselCard = ({ data }) => {
    ...
    <div className="vip-card">
      ...
      <div className="vip-card-content">
        ...
        <div className="d-flex justify-content-between align-items-center mt-auto w-100">
          <span className="h5">${data.price} {t.perPerson}</span>
...
export default FeaturedToursCarouselCard;